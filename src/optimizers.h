...
namespace litenet::optimizers {
    class Optimizer {
        public:
            ...
            virtual void update(layers::Layer &layer, const Matrix &dWeights, const Matrix &dBiases) = 0;
        protected:
            double learningRate;
    };
    class SGD : public Optimizer {
        public:
            ...
            void update(layers::Layer &layer, const Matrix &dWeights, const Matrix &dBiases) override;
    };
