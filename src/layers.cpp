...
litenet::Matrix litenet::layers::Layer::getWeights() const {
    return weights;
}

litenet::Matrix litenet::layers::Layer::getBiases() const {
    return biases;
}

void litenet::layers::Layer::setWeights(const Matrix &weights) {
    this->weights = weights;
}

void litenet::layers::Layer::setBiases(const Matrix &biases) {
    this->biases = biases;
}

litenet::layers::Dense::Dense(int inFeatures, int outFeatures, const std::string &activation, std::unique_ptr<litenet::initializers::Initializer> kernel_initializer, std::unique_ptr<litenet::initializers::Initializer> bias_initializer) {
...
void litenet::layers::Dense::build() {
...
litenet::Matrix litenet::layers::Dense::forward(const Matrix &inputs) {
...
std::tuple<litenet::Matrix, litenet::Matrix, litenet::Matrix> litenet::layers::Dense::backward(const Matrix &dOutput) {
...
litenet::Matrix litenet::layers::Dense::applyActivation(const Matrix &m) {
...
litenet::Matrix litenet::layers::Dense::applyActivationPrime(const Matrix &m) {
    if (activation == "sigmoid") {
